...
import SPEducationList from "./SPEducationList";
import SPEducationView from './SPEducationView';

class SPEducationPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            displayDialog: false,
...
export default SPEducationPage;
