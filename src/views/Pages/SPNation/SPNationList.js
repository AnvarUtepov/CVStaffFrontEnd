...
class SPNationList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selItem: null,
    ...
    render() {
        var header = (
            <div className="p-clearfix" style={{ lineHeight: "1.87em" }}>
                <span>Справочник национальностей</span>
        ...
        return (
            <div className="animated fadeIn">
                ...
                <Card>
                    <CardHeader>
                        <i className="fa fa-align-justify" /> Национальности
                    </CardHeader>
                    <CardBody>
                        <DataTable
                            ref={el => (this.dt = el)}
...
SPNationList.propTypes = {
    refreshList: PropTypes.bool.isRequired
};

export default SPNationList;
